# Generated by Django 5.0.7 on 2024-08-12 13:27
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('authors', models.ManyToManyField(to='viewself.author', verbose_name='作者')),
                ('publish', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to='viewself.publish', verbose_name='出版社')),
            ],
        ),
    ]
